    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php
                if (isset($_GET['post_id'])) {
                    ...
                    if ($run_post) {
                        ...
                        echo "Error fetching post: " . mysqli_error($con);
                    }
                }
            ?>
            ...
            <form action="" method="post" id="f">
                ...
                <textarea class="form-control" cols="83" rows="4" name="content"><?php echo isset($post_con) ? htmlspecialchars($post_con) : ''; ?></textarea><br>
