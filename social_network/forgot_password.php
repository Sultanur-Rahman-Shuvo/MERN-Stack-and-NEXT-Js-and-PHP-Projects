...
if (isset($_POST['submit'])) {
    ...
    $email = isset($_POST['email']) ? htmlentities(mysqli_real_escape_string($con, $_POST['email'])) : '';
    $recovery_account = isset($_POST['recover_account']) ? htmlentities(mysqli_real_escape_string($con, $_POST['recover_account'])) : '';

    if ($email && $recovery_account) {
