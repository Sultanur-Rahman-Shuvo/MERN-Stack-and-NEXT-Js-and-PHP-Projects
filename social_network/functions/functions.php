		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-warning'>Comment</button></a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
...
function user_posts(){
	...
	$ger_posts = "select * from posts where user_id='$u_id' ORDER by 1 DESC LIMIT 5";
	$run_posts = mysqli_query($con, $ger_posts);
	while($row_posts = mysqli_fetch_array($run_posts)){
		$post_id = $row_posts['post_id'];
		$user_id = $row_posts['user_id'];
		$content = $row_posts['post_content'];
					...
					<div class='row' id='find_people'>
						<div class='col-sm-4'>
							<a href='user_profile.php?u_id=$user_id'>
								<img src='users/$user_image' width='150px' height='140px' title='$username' style='float:left; , magrin:1px'>
							</a>
						</div><br><br>
						<div class='col-sm-6'>
