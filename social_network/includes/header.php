...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home.php">SocialBook</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <form class="navbar-form navbar-left" method="get" action="results.php">
                        ...
                        <button type="submit" class="btn" style="background: #079992;color: #fff;"
                            onmouseover="this.style.background='#38ada9'; this.style.color='#e0f7fa';"
                            onmouseout="this.style.background='#079992'; this.style.color='#fff';"
