        ...
        <div class="col-sm-8">
			...
			<div>
				...
				<ul class='nav pull-left' style='position:absolute;top:10px;left:40px;'>
					<li class='dropdown'>
						<button id='chng_btn' class='dropdown-toggle btn' data-toggle='dropdown'>Change Cover</button>
			...
			while($row_posts = mysqli_fetch_array($run_posts)){
				...
				if($content == "No" && strlen($upload_image) >= 1){
					...
					<div id='own_posts'>
						...
						<a href='edit_post.php?post_id=$post_id' style='float:right;'><button style='margin-right:5px;margin-left: 5px;' class='btn btn-info'>Edit</button></a>
